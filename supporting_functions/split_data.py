...
def main():
    ...
    data_root = r"C:\Users\JJJ\my\data\.images\FAST\rawdata\RUQ\classification\sigmoid"
    ...
    # 建立保存训练集的文件夹
    train_root = os.path.join(data_root,"split5", "train")
    mk_file(train_root)
    ...
    # 建立保存验证集的文件夹
    val_root = os.path.join(data_root,"split5", "val")
    mk_file(val_root)
    for cla in image_class:
        # 建立每个类别对应的文件夹
